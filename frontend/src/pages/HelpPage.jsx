		...
		<AppShell crumb={['Bogofy', 'Help & docs']}>
			<div className="bogo-page-header">
				<div>
					...
					<div
						className="bogo-page-header__desc">{__( 'How Bogofy rules work and answers to common questions.', 'bogofy' )}</div>
				</div>
				<button
			...
			<div className="bogo-type-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)', marginTop: 0 }}>
				{ruleTypes.map( ( t ) => (
					<div key={t.title} className="bogo-panel"
					     style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
						<div className="bogo-pkg" style={{
							width: 34,
							height: 34,
							borderRadius: 8,
