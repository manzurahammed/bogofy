	...
	return (
		<AppShell crumb={['Bogofy', 'Analytics']}>
			...
			<div className="bogo-chart-card" style={{ marginTop: 18 }}>
				<div className="bogo-section-header__title" style={{ marginBottom: 4 }}>Revenue &amp; orders over time
				</div>
				<div className="bogo-section-header__meta" style={{ marginBottom: 18 }}>Per-rule charts will appear here
					once enough order data is collected
				</div>
				<div style={{
			...
			<div className="bogo-panel"
			     style={{ marginTop: 18, display: 'flex', gap: 14, alignItems: 'flex-start', padding: '18px 20px' }}>
