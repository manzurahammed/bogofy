...
function SettingsPage() {
  ...
  if (fetchError) return (
    <AppShell crumb={['Bogofy', __('Settings', 'bogofy')]}>
      <div style={{ textAlign: 'center', padding: 48, color: 'var(--muted)' }}>{__('Failed to load settings.', 'bogofy')}</div>
    </AppShell>
  );
      ...
      <div style={{ maxWidth: 760 }}>
        <form onSubmit={handleSubmit} className="bogo-col" style={{ gap: 22 }}>
          <div>
            ...
            <div className="bogo-page-header__desc">{__('How Bogofy offers are presented on product pages and in the cart.', 'bogofy')}</div>
          </div>
            ...
            <div className="bogo-settings-list">
              <div className="bogo-settings-list__row">
                <div className="bogo-col">
                  ...
                  <div className="bogo-settings-list__desc">{__('Turn all Bogofy functionality on or off globally.', 'bogofy')}</div>
                </div>
                <button
                  type="button"
              ...
              <div className="bogo-settings-list__row">
                <div className="bogo-col">
                  <div className="bogo-settings-list__name">{__('Show “Bogofy” badge on product cards', 'bogofy')}</div>
                  <div className="bogo-settings-list__desc">{__('Highlights eligible products in shop & category pages.', 'bogofy')}</div>
                </div>
                <button
                  type="button"
              ...
              <div className="bogo-settings-list__row">
                <div className="bogo-col">
                  <div className="bogo-settings-list__name">{__('Show product page messages', 'bogofy')}</div>
                  <div className="bogo-settings-list__desc">{__('Display Bogofy offer messages on individual product pages.', 'bogofy')}</div>
                </div>
                <button
                  type="button"
              ...
              <div className="bogo-settings-list__row">
                <div className="bogo-col">
                  ...
                  <div className="bogo-settings-list__desc">{__('Label shown next to free items in cart.', 'bogofy')}</div>
                </div>
                <input
          ...
          <div>
            <div className="bogo-section-header" style={{ margin: '0 0 12px' }}>
              ...
              <div className="bogo-section-header__meta">{__('Encourage shoppers to qualify', 'bogofy')}</div>
            </div>
            <div className="bogo-settings-list">
              <div className="bogo-settings-list__row">
                <div className="bogo-col">
                  <div className="bogo-settings-list__name">{__('Cart notice text', 'bogofy')}</div>
                  <div className="bogo-settings-list__desc">{__('Notice shown when a Bogofy deal is applied at checkout.', 'bogofy')}</div>
                </div>
                <input
                  className="bogo-form-input"
          ...
          <div>
            <div className="bogo-section-header" style={{ margin: '0 0 12px' }}>
              ...
              <div className="bogo-section-header__meta">{__('How shoppers will see it', 'bogofy')}</div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              <div className="bogo-panel" style={{ padding: 18 }}>
                <div style={{ fontSize: 11.5, color: 'var(--muted)', marginBottom: 10 }}>{__('Product card badge', 'bogofy')}</div>
                <div style={{ borderRadius: 10, overflow: 'hidden', border: '1px solid var(--line)' }}>
                  ...
                  <div style={{ padding: 12 }}>
                    <div style={{ fontSize: 13, fontWeight: 500 }}>{__('Example Product', 'bogofy')}</div>
                    <div className="bogo-mono" style={{ fontSize: 12, color: 'var(--muted)', marginTop: 3 }}>$48.00</div>
                  </div>
                </div>
              </div>
              <div className="bogo-panel" style={{ padding: 18 }}>
                <div style={{ fontSize: 11.5, color: 'var(--muted)', marginBottom: 10 }}>{__('Cart notice', 'bogofy')}</div>
