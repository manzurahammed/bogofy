...
import { HomeIcon, TagIcon, WandIcon, SettingsIcon, HelpIcon } from "../Icons";
...
function Sidebar() {
  ...
  return (
    <aside className="bogo-sidebar">
      ...
      />
      <SbItem
        label={__("Bogofy Rules", "bogofy")}
        Icon={TagIcon}
        active={currentTab === "rules" && !isCreating}
        onClick={() => navigate("rules")}
      />
      <SbItem
        label={__("New rule", "bogofy")}
        Icon={WandIcon}
        active={isCreating}
