    ...
    <>
      <div className="bogo-wizard__card">
        ...
        <div className="bogo-wizard__subtitle">
          {__(
            "Customer must add these to cart for the offer to apply.",
            "bogofy",
          )}
        </div>
        ...
        <div className="bogo-row" style={{ gap: 10, marginTop: 8 }}>
          <label className="bogo-form-label" style={{ margin: 0 }}>
            {__("Minimum quantity to trigger", "bogofy")}
          </label>
          <input
            type="number"
            ...
            onChange={(e) =>
              setFormData((p) => ({
                ...p,
                buy_quantity: Number(e.target.value),
              }))
            }
          />
          <span style={{ color: "var(--muted)", fontSize: 12 }}>
            {__("items in cart", "bogofy")}
          </span>
        </div>
      </div>
      ...
      {showFreeSelector && (
        <div className="bogo-wizard__card">
          ...
          <div className="bogo-wizard__subtitle">
            {__("What customers receive when the trigger is met.", "bogofy")}
          </div>
          <div style={{ marginTop: 14 }}>
            ...
            {errors.free_products && (
              <div className="bogo-form-error">{errors.free_products}</div>
            )}
          </div>
          ...
          >
            ...
            <div className="bogo-col bogo-fill">
              ...
              >
                {__("The gift item is added to the cart at no cost.", "bogofy")}
              </div>
            </div>
          </div>
