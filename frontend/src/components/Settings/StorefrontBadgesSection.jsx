    ...
    <div>
      <div className="bogo-section-header" style={{ margin: "0 0 12px" }}>
        <div className="bogo-section-header__title">
          {__("Storefront badges", "bogofy")}
        </div>
        <div className="bogo-section-header__meta">
          {__("Visible to shoppers", "bogofy")}
        </div>
      </div>
      <div className="bogo-settings-list">
        <SettingsRow
          ...
          desc={__(
            "Turn all Bogofy functionality on or off globally.",
            "bogofy",
          )}
        >
          <ToggleButton
        ...
        <SettingsRow
          ...
          desc={__(
            "Highlights eligible products in shop & category pages.",
            "bogofy",
          )}
        >
          <ToggleButton
            on={formData.show_shop_badges}
            onClick={() => onToggle("show_shop_badges")}
          />
        </SettingsRow>
        <SettingsRow
          name={__("Show product page messages", "bogofy")}
          desc={__(
            "Display Bogofy offer messages on individual product pages.",
            "bogofy",
          )}
        >
          <ToggleButton
            on={formData.show_product_page_messages}
